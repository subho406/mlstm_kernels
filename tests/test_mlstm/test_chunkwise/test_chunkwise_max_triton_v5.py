...
# The errors for max_triton_v5xlchunksize are slightly higher than for max_triton_v3,
# so we increase the tolerances for the tests slightly.
...
class TestChunkwiseTritonVsStableTorch:
    ...
    def test_chunkwise_triton_vs_stable_torch_fp32(
        ...
        template_test_parallel_interface(
            ...
            target_fn=mlstm_chunkwise_max_triton_v5xlchunksize,
            baseline_name="parallel_stable_ag",
            target_name="max_triton_v5xlchunksize",
            S=S,
            B=B,
            NH=NH,
            DHQK=DHQK,
