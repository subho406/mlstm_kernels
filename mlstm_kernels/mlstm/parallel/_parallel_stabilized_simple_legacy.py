...
def parallel_stabilized_simple(
    ...
    **kwargs,
    ...
    """
    NOTE: This is the mLSTM implementation that was used in the xLSTM paper. Only the interface is adapted to the kernel interface
    ...
    keys = k
    values = v
    igate_preact = i.unsqueeze(-1)
    fgate_preact = f.unsqueeze(-1)
