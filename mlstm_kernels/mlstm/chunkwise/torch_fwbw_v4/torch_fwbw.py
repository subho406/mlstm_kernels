...
from ._torch_bw import _mlstm_chunkwise_bw
from ._torch_fw import _mlstm_chunkwise_fw

# PyTorch.

# Forward and backward pass of the mLSTM chunkwise formulation.
# v4: this version fuses the forget and input gate gradient computation in the backward pass.
# TODO it should also always use the more stable version of the forget gate computation which never
# subtracts large numbers from each other.
