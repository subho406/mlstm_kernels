...
from .bw_recurrent import mlstm_siging_chunkwise__recurrent_bw_dC
...
def mlstm_siging_chunkwise_bw(
    ...
    if matCstate_all is None:
        assert (matCstate_all is None) and (
            vecNstate_all is None
        ), "Either all or none of the states must be provided."

        matCstate_all, vecNstate_all = mlstm_siging_chunkwise__recurrent_fw_C(
            matK=matK,
            matV=matV,
            vecF=vecF,
            vecI=vecI,
    ...
    matDeltaC_states = mlstm_siging_chunkwise__recurrent_bw_dC(
    ...
    #! compute deltaV
    matDeltaV = mlstm_siging_chunkwise__parallel_bw_dV(
        matQ=matQ,
        matK=matK,
        matV=matV,
        vecI=vecI,
    ...
    #! compute deltaK
    matDeltaK = mlstm_siging_chunkwise__parallel_bw_dK(
        matQ=matQ,
        matK=matK,
        matV=matV,
        vecI=vecI,
    ...
    #! compute deltaQ
    matDeltaQ = mlstm_siging_chunkwise__parallel_bw_dQ(
        matQ=matQ,
        matK=matK,
        matV=matV,
        vecI=vecI,
